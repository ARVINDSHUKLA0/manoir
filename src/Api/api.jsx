...
export const addCartApi = async (userId, productId, productSize) => { 
    try {
        const data = await axios.post(`${Url}/cart/add`, { productId, userId, productSize })
...
export const addWishlistApi = async (userId, productId, productSize) => {
    try {
        console.log("productSize", productSize);
        const data = await axios.post(`${Url}/wishlist/add`, { productId, userId, productSize })
