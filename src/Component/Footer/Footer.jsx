        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-3 col-md-6 col-6">
                    {/* <h3>Heading</h3> */}
                    <ul className='text-white'> 
                        <li className='d-flex gap-2'><p className=' max-width'><i className="fa-solid fa-location-dot text-white"></i> : </p> <p className=''>C-26, Sector - 65, Noida, Uttar Pradesh (INDIA)</p></li>
                        <li className='d-flex gap-2'><p className=''><i className="fa-solid fa-envelope text-white"></i> :</p> <p className=''>support@doozie-do.com</p></li>
                        <li className='d-flex gap-2'><p className=''><i className="fa-solid fa-phone text-white"></i>  : </p> <p className=''>+91 78381 30078</p></li> 
                    </ul>
                </div>
            </div>
        </div>
