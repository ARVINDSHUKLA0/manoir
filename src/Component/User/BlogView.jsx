        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-9 col-md-8 col-12 mb-3">
                    ...
                    <div>
                        <img src={`${Url}/${blogData && blogData.image}`} className='w-50 m-auto d-block img-fluid' alt={blogData && blogData.altTag} />
                    </div>
                    <div>
                                ...
                                return(
                                    <div className='py-3 d-flex border-bottom-not-last align-items-center gap-3' key={blogValue._id}>
                                        <div className='recent-blog-img-box m-auto'>
                                            <img src={`${Url}/${blogValue.image} `} alt={blogValue.altTag} className=' img-fluid ' />
                                        </div>
