...
export default function Cart() {
  ...
  return (
    <> 
      <ToastContainer/>
      <div  className="main-color pt-3 pb-3">
      <Navbar /> 
      </div>
      {checkoutProductList?
                  ...
                  <MDBRow>
                          ...
                          <div className="d-lg-flex d-block justify-content-between border-bottom mb-2 pb-2" >
                            <div className="d-flex flex-row align-items-center">
                              ...
                              <div className="ms-3 me-3">
                                <MDBTypography tag="h6" className="cl-blue mb-2">
                                  <Link to={`/productview/${product.slug}/${product._id}`}>
                                    {product.productName}
                                  </Link>
                                </MDBTypography>
                                <p className="fs-14">Size : <span className="text-muted">{cv.productSize}</span></p>
                    ...
                    <MDBCol lg="5">
                      <MDBCard className="bg-primar bg-lightgra bg-white rounded-3">
                        <MDBCardBody>
                          <div className="d-flex justify-content-between align-items-center mb-4">
                            <MDBTypography tag="h5" className="mb-0 textBrown"> 
