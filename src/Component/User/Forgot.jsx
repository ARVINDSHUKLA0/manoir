...
import logoImg from '/assets/img/logo-long-dark.png'
    ...
    <section className='overflow-hidden'>
            <div className="row min-vh-100">
                <div className="col-md-6 col-12 sm-none">
                    <div className='h-100'> 
                        <img src={bannerImg} className='overflow-hidden h-100 '  alt="forgot Password" />
                    </div>
                </div>
      ...
      <Container component="main" maxWidth="xs" className='main-side-form'>
        ...
        >
            <div className='text-center mb-4'>
                <Link>
                <img src={logoImg} style={{width: '185px'}} alt="doozie do" />
                </Link>
            </div>
